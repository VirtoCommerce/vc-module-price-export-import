...
namespace VirtoCommerce.SimpleExportImportModule.Web
{
    public class Module : IModule
    {
        ...
        public void Initialize(IServiceCollection serviceCollection)
        {
            ...
            var connectionString = configuration.GetConnectionString("VirtoCommerce.VirtoCommerceSimpleExportImport") ?? configuration.GetConnectionString("VirtoCommerce");
        ...
        public void PostInitialize(IApplicationBuilder appBuilder)
        {
            ...
            permissionsProvider.RegisterPermissions(ModuleConstants.Security.Permissions.AllPermissions.Select(x =>
                new Permission()
                {
                    GroupName = "VirtoCommerceSimpleExportImport",
